...
function renderShapesRedBoxMan(location) {
    ...
    gc.fillRect(location.x+15, location.y+15, 35, 25);
    gc.beginPath();
    gc.strokeStyle = outlineColor;
    gc.lineWidth = 1;
    gc.rect(location.x+15, location.y+15, 35, 25);
    gc.stroke();
    
    gc.fillStyle = eyeColor;
    gc.fillRect(location.x+65, location.y+15, 35, 25);
    gc.beginPath();
    gc.strokeStyle = outlineColor;
    gc.lineWidth = 1;
    gc.rect(location.x+65, location.y+15, 35, 25);
    gc.stroke();
    
    gc.fillStyle = pupilColor;
    gc.fillRect(location.x+30,location.y+25,5,5);
    gc.fillRect(location.x+80,location.y+25,5,5);
        
    gc.fillRect(location.x+20,location.y+65,80,10);
    gc.fillRect(location.x+30,location.y+88,60,20);
    gc.fillRect(location.x+35,location.y+108,50,15);
    gc.fillRect(location.x+30,location.y+123,10,10);
    gc.fillRect(location.x+80,location.y+123,10,10);
