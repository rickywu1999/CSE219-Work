...
public class RedBoxManRenderer extends Application {
	...
	gc.stroke();
        ...
        gc.fillRect(location.getX()+15,location.getY()+15,35,25);
        gc.beginPath();
	gc.setStroke(Paint.valueOf(outlineColor));
	gc.setLineWidth(1);
	gc.rect(location.getX()+15, location.getY()+15, 35, 25);
	gc.stroke();
        
        gc.setFill(Paint.valueOf(eyeColor));
        gc.fillRect(location.getX()+65,location.getY()+15,35,25);
        gc.beginPath();
	gc.setStroke(Paint.valueOf(outlineColor));
	gc.setLineWidth(1);
	gc.rect(location.getX()+65, location.getY()+15, 35, 25);
	gc.stroke();
        
        gc.setFill(Paint.valueOf(pupilColor));
        gc.fillRect(location.getX()+30,location.getY()+25,5,5);
        gc.fillRect(location.getX()+80,location.getY()+25,5,5);
        
        gc.fillRect(location.getX()+20,location.getY()+65,80,10);
        gc.fillRect(location.getX()+30,location.getY()+88,60,20);
        gc.fillRect(location.getX()+35,location.getY()+108,50,15);
        gc.fillRect(location.getX()+30,location.getY()+123,10,10);
        gc.fillRect(location.getX()+80,location.getY()+123,10,10);
